        ...
        <>
            <div className="flex gap-2 mt-3">
                <button
                    ...
                    className="text-xs px-3 py-2.5 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition-colors min-h-[44px]"
                >
                    Edit
                </button>
                <button
                    ...
                    disabled={deleting}
                    className="text-xs px-3 py-2.5 border border-red-200 text-red-600 rounded-md hover:bg-red-50 transition-colors disabled:opacity-50 min-h-[44px]"
                >
