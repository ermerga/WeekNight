        ...
        <div className="min-h-[calc(100vh-60px)] flex items-center justify-center bg-[#FAF9F6] px-4">
            <div className="w-full max-w-sm">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-white border border-[#E8E5DF] text-gray-700 py-2.5 px-4 rounded-lg text-sm hover:bg-gray-50 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#2D6A4F] focus:ring-offset-2 mb-5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
