...
export default async function InventoryPage() {
    ...
    return (
        <main className="bg-gray-100 min-h-[calc(100vh-60px)]"><div className="max-w-4xl mx-auto p-6">
            <h1 className="text-3xl font-bold text-gray-900 mb-6">My Inventory</h1>
            ...
            <div className="bg-white rounded-lg shadow mb-8">
                ...
                {inventory.length === 0 ? (
                    <p className="p-4 text-gray-900">No items in your inventory yet.</p>
                ) : (
  ...
  justify-between items-center hover:bg-gray-50">
                                <div>
                                    <span className="font-medium text-gray-900">{item.foodItem.name}</span>
